-- Interpretación: monedas más inestables frente al USD.
...
-- Here will be the upcomming months and will be updated when needed
...
-- At last the overall year performance for each exchange_rate
